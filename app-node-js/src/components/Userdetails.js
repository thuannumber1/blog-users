...
export default function Userdetails(props) {
    ...
    function onsubmit(e){
        ...
        if(values.name && values.email!==""){
            axios.put('http://127.0.0.1:5000/api/v1/users'+a.user_id,values).resp(resp=>console.log(resp))
    ...
    const onSubmit=(e)=>{
        ...
        const a = posts.find(o=>o.name===b)
            ...
            axios.put('http://127.0.0.1:5000/api/v1/users/'+a.user_id,values).then(resp=>console.log(resp)) 
    ...
    return (
        ...
        <Card.Meta>
            <span className='date'>BalaBala in 2021</span>
        </Card.Meta>
        <Card.Description>
          {/* {
